...
/*	public LoginUserInfo getLoginUser(HttpServletRequest request) {
	...
	public LoginUserInfo getLoginUser(HttpServletRequest request) {
		String lvcode = this.getParam(request, "lvcode");
		LoginUserInfo loginUser = (LoginUserInfo)MemcachedUtil.getInstance().getAttribute(lvcode);
		logger.info("memcache:agentId=" + loginUser.getAgentId());
		return loginUser;
	}
