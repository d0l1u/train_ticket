	...
	<div class="content shouy oz">
    	...
    	<div class="left_con oz">
            <div class="tip_term oz" style="width:756px;margin:10px auto 0;">
            	...
            	<p class="price_tip">温馨提醒：我们会将在4月6日以后对未实名的代理商暂停提供火车票预订服务，请各位代理商抓紧绑定，谢谢！<span 
            		style="color:red;cursor:pointer;line-height:24px;font-weight:bold;" 
            		onclick="javascript:window.location.href='/joinUs/realNameAuth.jhtml'"> 开始实名</span></p>
            	<!-- 
            	 <p class="price_tip">温馨提醒：由于系统升级，现暂停服务，具体恢复时间请关注公告通知！</p> -->
            </div>
            ...
            <div class="ban mb10 oz">
            	...
            	<img src="/images/ban716x90.gif" width="756" height="90" alt="" />
            </div>
            <!--常见问题 start-->
             <div class="ques oz">
            	<h3>常见问题</h3>
