...
<body>
	<div class="content oz">
    	...
    	<div class="left_con oz">
            ...
            <!--提醒通告模块 end-->
            <div class="special mb10">
            	<a href="#"><img src="/images/special_696x122.jpg" alt="开通专题" /></a>
            </div>
         	<!--我要加盟-tab start-->
                ...
                <table class="user_mes user_mes_r">
                    ...
                    <tr>
                    	<td colspan="4" class="xieyi">
                    		<input type="checkbox" id="read_chk" /><span><label for="read_chk">已阅读并同意</label><a href="javascript:void(0);" onclick="window.open('/pages/common/protocolPop.jsp')">19e火车票线下代购服务协议</a></span>
                    	</td>
                    </tr>
                </table>
	...
	$().ready(function(){
		...
		function checkEmpty(id, msg){
			if($.trim($("#"+id).val())=="" || ($("#"+id).css("color").toLowerCase()=="#aaa" && id!="shop_short_name")
				...
				return true;
			}else if(id=='user_phone' && !/^1(3[\d]|4[57]|5[012356789]|8[012356789])\d{8}$/g.test($.trim($("#user_phone").val()))){
