    	...
    	<div class="left_con oz">
        	...
        	<c:choose>
        		<c:when test="${fromFunc eq 'payNotify'}">
        			<div class="oz">
		            	 <p class="tijiao"><input type="button" value="订单查询" class="btn" onclick="javascript:window.location='/chunqiu/query/queryOrderList.jhtml'" /></p>
		            </div>
        		</c:when>
        		<c:otherwise>
		          	<div class="vertified_btn oz">
		            	 <p class="tijiao"><input type="button" value="返 回" class="btn btn2" onclick="window.location='/chunqiu/query/queryOrderList.jhtml'" />
