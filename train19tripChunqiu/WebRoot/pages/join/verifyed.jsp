               	...
               	<div class="backg oz">
                    ...
                    <div class="vertified_btn oz">
	                	<p>
	                		<!-- 审核通过显示续费按钮 -->
	                		<c:if test="${productVo != null && agentVo.estate eq '33'}">
	                			<input type="button" value="续 费" class="btn btn1" onclick="javascript:window.location='/chunqiu/joinUs/gotoRepayPage.jhtml'" />
	                		</c:if>
	                		<input type="button" value="投诉建议" class="btn btn2" onclick="javascript:window.location='/chunqiu/complain/complainIndex.jhtml?ques_Id=1'" />
	                	</p>
	                </div>
