...
<body>
	<div class="yew_r_con protocol_con oz"><!-- InstanceBeginEditable name="EditRegion3" -->
          <h2>火车票线下代购服务协议</h2>
          <div class="con_con">
          	<h5>火车票线下代购服务协议</h5>
            <ul>
              ...
              <li><h3>五、免责条款</h3></li>
              <li><p> 一九易火车票业务禁止代理商向用户收取票面价格以外的服务费用，如果因此类费用发生纠纷和一九易公司没有任何关系。</p>
              <li><p>一九易禁止代理商在未征得用户允许的情况向用户出售火车保险，如果因此发生的服务纠纷和一九易公司没有任何关系。</p>
              <li><p>在系统服务期间，一九易将有权根据需要，随时对产品的服务内容进行更新或删除，且无需另行通知或取得代理商的同意。</p>
              </li>
              <li><p>一九易提供的火车票信息、列车时刻信息、客票余额信息、座位信息、票价等信息全部来自互联网，在代购的火车票的车次、票价、始发时间、到站时间等以实际为准，本公司对此等信息的准确性、完整性、合法性或真实性均不承担责任。
              </p></li>
               <li><h3>六、其他</h3></li>
              </li>
          ...
          <div class="notice_wrap oz">
       	  <div class="back"><input type="button" class="btn" value="关闭" onclick="javascript:closeWin();" /></div>
       	  </div>
