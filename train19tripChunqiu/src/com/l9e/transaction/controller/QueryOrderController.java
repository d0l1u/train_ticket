...
public class QueryOrderController extends BaseController {
	...
	public String queryOrderList(HttpServletRequest request, 
		...
		LoginUserInfo loginUser = this.getLoginUser(request);//session取值，用户已登录
		String userId = loginUser.getUserId();
		logger.info("【当前登录春秋用户】user_id:"+userId);
...
//		}
		...
		logger.info("开车后的停止退票时间:"+this.getSysSettingValue("stop_refundTicket_time", "stop_refundTicket_time"));
