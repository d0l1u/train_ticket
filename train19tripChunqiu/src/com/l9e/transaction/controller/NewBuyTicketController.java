...
public class NewBuyTicketController extends BuyTicketBase { 
	...
	public void newQueryData(Map<String, String> paramMap,HttpServletRequest request,HttpServletResponse response){
		...
		try {
			param.append("travel_time=").append(travel_time).append("&from_station=").append(URLEncoder.encode(from_station,"UTF-8"))
			.append("&arrive_station=").append(URLEncoder.encode(arrive_station,"UTF-8")).append("&channel=").append("inner");
