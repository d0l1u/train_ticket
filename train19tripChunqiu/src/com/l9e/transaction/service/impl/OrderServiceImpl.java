...
//		orderDao.updateOrder(refund.getOrder_id());
	...
	public void addRefundStream(List<Map<String, String>> refundList, String order_id) {
		...
		for(Map<String, String> refundMap : refundList){
			...
			refundMap.put("pay_channel", pay_channel);
