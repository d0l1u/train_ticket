...
import com.l9e.transaction.controller.AlipayController;
...
public class AlipayNotify {
	...
	public static boolean verify(Map<String, String> params) {
		...
		logger.info("mysign::" + mysign.toString());
	...
	private static String verifyResponse(String notify_id) {
		...
		veryfy_url = veryfy_url + "partner=" + partner + "&notify_id="
				+ notify_id;
		logger.info("veryfy_url====" + veryfy_url.toString());
	...
	private static String checkUrl(String urlvalue) {
		...
		try {
			...
			logger.info("inputLine====" + inputLine.toString());
		} catch (Exception e) {
			e.printStackTrace();
			inputLine = "";
		}
