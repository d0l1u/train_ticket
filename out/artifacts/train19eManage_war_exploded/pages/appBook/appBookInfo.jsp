...
<script type="text/javascript">
	...
	function refuseRefund(){
		...
		if(confirm("确认拒绝退款？并且在备注中说明拒绝原因。")){
			$("#refundForm").attr("action","/appBooking/updateRefuseRefund.do");
	...
	function differRefund(){
		...
		if(confirm("确认差额退款？并且核对退款金额。")){
			$("#differForm").attr("action","/appBooking/updateDifferRefunding.do");
	...
	function switch_ignore(refund_deadline_ignore){
		if(confirm("确认切换无视退款时间？")){
			window.location='/appbooking/updateAppSwitch_ignore.do?order_id=${orderInfo.order_id}&refund_deadline_ignore='+refund_deadline_ignore;
		}
	}
         	...
         	<div class="pub_order_mes oz mb10_all">
                ...
                <div class="pub_con">
                	<table class="pub_table">
                        ...
                        <tr>
                         	<td>用户电话：<span>${orderInfo.app_phone }&nbsp;</span></td>
