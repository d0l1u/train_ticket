...
<html>
	<head>
		...
		function mingxi(refund_seq,create_time){
			$("form:first").attr("action","/gtStation/queryGtStationInfo.do?refund_seq="+refund_seq+"&order_status=11&begin_time="+create_time);
			$("form:first").submit();
		}
		
		function addRefunds(){
		$("form:first").attr("action","/gtStation/gtAddRefundsPage.do");
		$("form:first").submit();
		}
...
<style>
	...
	<body><div></div>
		<div class="book_manage oz">
			<form action="/gtStation/queryGtStationList.do" method="post" name="myform" id="myform">
