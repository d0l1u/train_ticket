...
<html>
	...
	function exportExcel() {
		$("form:first").attr("action","/orderForExcel/excelExportXcBooking.do");
		$("form:first").submit();
		$("form:first").attr("action","/xcBooking/queryXcBookList.do");
	}
	$().ready(function(){
...
#hint{width:700px;border:1px solid #C1C1C1;background:#F0FAC1;position:fixed;z-index:9;padding:6px;line-height:17px;text-align:left;overflow:auto;} 
	...
	<body><div></div>
		<div class="book_manage oz">
			<form action="/xcBooking/queryXcBookList.do" method="post">
				...
				<c:if test="${!empty isShowList}">
					<table>
						...
						<c:forEach var="list" items="${bookList}" varStatus="idx">
							...
							<td>
								<span><a href="/xcBooking/xcQueryBookInfo.do?order_id=${list.order_id}"  onmouseover="showdiv('${list.order_id}')" onmouseout="hidediv()" >明细</a>
								</span>
							</td>
							</tr>
						</c:forEach>
