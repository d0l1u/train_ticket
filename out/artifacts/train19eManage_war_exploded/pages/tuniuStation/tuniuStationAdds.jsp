...
<head>
		...
		function importExcel(){
			...
			if(confirm("确定上传？")){
			$("form:first").attr("action","/tuniuStation/tuniuAddRefunds.do?file="+file);
			$("form:first").submit();
			}
		}

		function goback(){
			$("form:first").attr("action","/tuniuStation/queryTuniuStationPage.do");
			$("form:first").submit();
		}
...
<body>
	<form action="/tuniuStation/tuniuAddRefunds.do" method="post" enctype="multipart/form-data" id="addForm" onsubmit="return checkSubmit();">
