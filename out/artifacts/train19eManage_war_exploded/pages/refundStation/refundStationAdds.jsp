...
<head>
		...
		function importExcel(){
			...
			if(confirm("确定上传？")){
			$("form:first").attr("action","/refundStation/refundAddRefunds.do?file="+file);
			$("form:first").submit();
			}
		}

		function goback(){
			$("form:first").attr("action","/refundStation/queryRefundStationPage.do");
			$("form:first").submit();
		}
...
<body>
	<form action="/refundStation/refundAddRefunds.do" method="post" enctype="multipart/form-data" id="addForm" onsubmit="return checkSubmit();">
