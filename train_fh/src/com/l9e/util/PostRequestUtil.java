...
public class PostRequestUtil {
	...
	public static String getPostRes(String charset, String strURL, String parm) {
		return getPostRes(charset, strURL, parm, null, null);
	}
	 ...
	 * @return
	 */
	public static String getPostRes(String charset, String strURL, String parm, String connectiontimeout,
			String readtimeout) {
		 ...
		 * 
		 */
		connectiontimeout = null;// Config.getProperty("connectiontimeout");
		 ...
		 * 
		 */
		readtimeout = null;// Config.getProperty("readtimeout");
		...
		try {
			...
			// TODO Auto-generated catch block
			logger.error("访问远程服务器错误POST：<" + strURL + "> " + e.getClass().getSimpleName(), e);
