...
public class HttpUtil {
	 ...
	 * @return
	 */
	public static String sendByPost(String url, String params, String inputCharset, int connectTimeout, int readTimeout) {
		...
		// logger.debug("返回浄1�7[" + strResponse.toString() + "]");
