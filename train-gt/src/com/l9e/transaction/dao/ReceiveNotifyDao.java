...
public interface ReceiveNotifyDao {
	...
	Integer updateOrderGtBookNotifyStatus(Map<String, String> paramMap);

	int updateOrderResultStatus(Map<String, String> updatenew);

	String queryBookNotifyStatus(String order_id);

    int queryOrderBookNotifyStartNum(String order_id);
}
