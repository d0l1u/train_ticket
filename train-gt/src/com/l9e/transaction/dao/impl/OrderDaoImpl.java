...
public class OrderDaoImpl extends BaseDao implements OrderDao {
	...
	public Map<String, String> queryOrderContactInfo(String orderId) {
		return (Map<String, String>) this.getSqlMapClientTemplate().queryForObject("order.queryOrderContactInfo",
				orderId);
	}
	...
	public Map<String, String> queryNotifyCpOrderInfo(String order_id) {
		return (Map<String, String>) this.getSqlMapClientTemplate().queryForObject("order.queryNotifyCpOrderInfo",
				order_id);
	}
	...
	public Map<String, String> queryOrderForRefund(String order_id) {
		return (Map<String, String>) this.getSqlMapClientTemplate().queryForObject("order.queryOrderForRefund",
				order_id);
	}
	...
	public Map<String, String> querySpecTimeBeforeFrom(String order_id) {
		return (Map<String, String>) this.getSqlMapClientTemplate().queryForObject("order.querySpecTimeBeforeFrom",
				order_id);
	}
	...
	public Map<String, String> queryOrderInfoByMap(Map<String, String> paramMap) {
		return (Map<String, String>) this.getSqlMapClientTemplate().queryForObject("order.queryOrderInfoByMap",
				paramMap);
	}
	...
	public Map<String, String> queryMerchantInfoByOrderId(String order_id) {
		return (Map<String, String>) this.getSqlMapClientTemplate().queryForObject("order.queryMerchantInfoByOrderId",
				order_id);
	}
	...
	public Map<String, String> queryCpSizeAndPrice(String order_id) {
		return (Map<String, String>) this.getSqlMapClientTemplate().queryForObject("order.queryCpSizeAndPrice",
				order_id);
	}
	...
	public Map<String, Object> queryAccountOrderInfo(Map<String, String> param) {
		return (Map<String, Object>) this.getSqlMapClientTemplate().queryForObject("order.queryAccountOrderInfo",
				param);
	}
	...
	public Map<String, String> queryRefundCpOrderInfo(Map<String, String> param) {
		return (Map<String, String>) this.getSqlMapClientTemplate().queryForObject("order.queryRefundCpOrderInfo",
				param);
	}
	...
	public String queryOrderId(Map<String, Object> paramMap) {
		...
		return (String) getSqlMapClientTemplate().queryForObject("order.selectOrderId", paramMap);
	}

	@Override
	public int updateOrderReqtoken(Map<String, Object> paramMap) {
		// TODO Auto-generated method stub
		return (Integer) this.getSqlMapClientTemplate().update("order.updateOrderReqtoken", paramMap);
	}

	@Override
	public int queryEopandpaynotifyCount(String supplierOrderId) {
		// TODO Auto-generated method stub
		return (Integer) this.getSqlMapClientTemplate().queryForObject("order.queryEopandpaynotifyCount",
				supplierOrderId);
	}

	@Override
	public int updateOrderInfo(Map<String, String> map) {
		// TODO Auto-generated method stub
		return (Integer) this.getSqlMapClientTemplate().update("order.updateOrderInfo", map);
	}

	@Override
	public int updateOrderConfirmNotifyUrl(Map<String, Object> paraMap1) {
		// TODO Auto-generated method stub
		return (Integer) this.getSqlMapClientTemplate().update("order.updateOrderConfirmNotifyUrl", paraMap1);
	}

	@Override
	public String selectSubOrder12306(Map<String, String> paramMap) {
		// TODO Auto-generated method stub
		return (String) getSqlMapClientTemplate().queryForObject("order.selectSubOutTicketBillno", paramMap);
	}

	@Override
	public List<TicketEntrance> selectOrderTicketEntrance(String order_id) {
		return getSqlMapClientTemplate().queryForList("order.selectTicketEntrance", order_id);
	}

	@Override
	public Date queryPayLimitTime(String order_id) {

		return (Date) getSqlMapClientTemplate().queryForObject("order.queryPayLimitTime", order_id);
	}
