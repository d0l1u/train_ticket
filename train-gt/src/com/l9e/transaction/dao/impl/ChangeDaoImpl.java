...
public class ChangeDaoImpl extends BaseDao implements ChangeDao {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public Map<String, Object> selectChangeTicketEntrance(Map<String, Object> paramMap) {
        return (Map<String, Object>) this.getSqlMapClientTemplate().queryForObject(NAMESPACE + "selectChangeTicketEntrance", paramMap);
    }
