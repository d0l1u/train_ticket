...
public class DateUtil {
	 ...
	 * @return
	 */
	public static String timestampToString(java.sql.Timestamp date,String formatStr){
		SimpleDateFormat sdf=new SimpleDateFormat(formatStr);
		return sdf.format(date);
	}
	...
	public static void main(String[] args) {
		String dateString="2017-04-14 13:45:45";
		Date  l=stringToDate(dateString,DATE_FMT3);
		System.out.println(dateToString(dateAddMin(l,-10), DATE_FMT3));
		
		String pay_limit_time=DateUtil.dateToString(DateUtil.dateAddMin(DateUtil.stringToDate("2017-04-13 15:56:15",DateUtil.DATE_FMT3),28), DateUtil.DATE_FMT3);//限制28分钟内支付
		System.out.println(pay_limit_time);
	}
}
