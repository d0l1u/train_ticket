...
public class BaseController {
	...
	public LoginUserInfo getLoginUser(HttpServletRequest request) {
		return (LoginUserInfo) request.getSession().getAttribute(TrainConsts.INF_LOGIN_USER);
	}
	...
	/**
	 * request.getParameter ,把通过url gbk编码过后的value值转换成utf8的值
	 * @param param
	 * @return
	 */
	public String getParamGBKToUTF(HttpServletRequest request, String param){
		try {
			return request.getParameter(param) == null ? "" : new String(request.getParameter(param).getBytes("gbk"),"utf-8");
