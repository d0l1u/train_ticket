...
public class ElongOrderDaoImpl extends BaseDao implements ElongOrderDao{
	...
	@Override
	public String queryChangeCpPayMoney(Map<String, String> paramMap) {
		return	(String)this.getSqlMapClientTemplate().queryForObject("elongOrder.queryChangeCpPayMoney",paramMap); 		
	}


	@Override
	public String queryChangeFromTime(Map<String, String> paramMap) {
		return (String)this.getSqlMapClientTemplate().queryForObject("elongOrder.queryChangeFromTime",paramMap); 		
	}


	@Override
	public String getFakerLogContentByOrderId(String orderId) {
		return (String) this.getSqlMapClientTemplate().queryForObject("elongOrder.queryFakerLog", orderId);
	}


	@Override
	public List<String> findUsedAccountLogContentByOrderId(String orderId) {
		return  this.getSqlMapClientTemplate().queryForList("elongOrder.queryUsedAccountLog", orderId);
	}


	@Override
	public String queryUnVerLogContentByOrderId(String orderId) {
		return (String) this.getSqlMapClientTemplate().queryForObject("elongOrder.queryUnVerLog", orderId);
	}


	@Override
	public ElongOrderInfoCp queryElongCpInfoByCpId(String cp_id) {	
		return (ElongOrderInfoCp) this.getSqlMapClientTemplate().queryForObject("elongOrder.queryElongCpInfoByCpId",cp_id);
	}
	...
	public Map<String, Object> queryAccountOrderInfo(Map<String, String> param) {
		return (Map<String, Object>) this.getSqlMapClientTemplate().queryForObject("elongOrder.queryAccountOrderInfo", param);
	}
