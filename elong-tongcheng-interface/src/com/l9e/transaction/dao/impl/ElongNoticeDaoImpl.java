...
public class ElongNoticeDaoImpl  extends BaseDao  implements ElongNoticeDao{
	...
	@Override
	public void updateOrdersNotice(ElongNoticeVo elongNoticeVo) {
		this.getSqlMapClientTemplate().update("elongNotice.updateOrdersNotice",elongNoticeVo);
	}
	...
	@Override
	public void addNotice(ElongOrderNoticeVo notice) {
		this.getSqlMapClientTemplate().insert("elongNotice.addNotice",notice);
	}
	...
	@Override
	public Map<String, Object> queryAlterCpInfoById(String cpId) {
		return (Map<String, Object>)this.getSqlMapClientTemplate().queryForObject("elongNotice.queryAlterCpInfoById",cpId);
	}
