...
public class DBChangeInfo {
	 ...
	 * 改签记录所改签的车票
	 */
	private List<DBPassengerChangeInfo> cPassengers;
	...
	public List<DBPassengerChangeInfo> getcPassengers() {
		return cPassengers;
	}

	public void setcPassengers(List<DBPassengerChangeInfo> cPassengers) {
