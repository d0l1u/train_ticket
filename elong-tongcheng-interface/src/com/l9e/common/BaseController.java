...
public class BaseController {
	 ...
	 * @return String
	 */
	public String queryElongSysValueByName(String setting_name){
		String value = null;
		if(null == MemcachedUtil.getInstance().getAttribute(setting_name)){
			value = commonService.queryElongSysValueByName(setting_name);
	 ...
	 * @return String
	 */
	public String queryElongSysValueByName(String setting_name,long time){
		String value = null;
		if(null == MemcachedUtil.getInstance().getAttribute(setting_name)){
			value = commonService.queryElongSysValueByName(setting_name);
