...
public class HttpsUtil {
	...
	*/
			...
			*/
			...
			logger.info("响应头："+conn.getHeaderFields());
			conn.disconnect();
	...
	public static void main(String[] args){
		System.out.println(HttpsUtil.sendHttps("https://kyfw.12306.cn/otn/lcxxcx/query?purpose_codes=ADULT&queryDate=2014-12-19&from_station=BJP&to_station=XTP"));
	}
