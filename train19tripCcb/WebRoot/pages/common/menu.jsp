...
<li <% if (isMyMenu(request, "book")) { %> class="current no_lborder" <% } %> ><a href="/buyTicket/bookIndex.jhtml">车票预订</a>
</li>
<li <% if (isMyMenu(request, "query")) { %> class="current no_lborder" <% } %> ><a href="/query/queryOrderList.jhtml">我的订单</a>
</li>
<li <% if (isMyMenu(request, "complain")) { %> class="current no_lborder" <% } %> ><a href="/complain/complainIndex.jhtml">投诉/建议</a>
</li>
