...
<style>
	/* select */
.select{position:absolute;float:right;margin:0 10px;width:114px;padding-left:550px;*+padding-left:0px;z-index:10;}
...
.select dt:hover,.select dt.cur{border:1px solid #409DFE;box-shadow:0 0 1px #409DFE;cursor:pointer;}
				        ...
				        <dl class="oz">
				            <dd>
				                ...
				                <div class="info_txt1 oz" id="visitant_service">
				                	<p class="info_icon1 fl" style="margin:6px 6px 2px;">高额赔付：人均<span id="gepf"></span></p>
				                    <p class="info_icon1 fl" style="margin:6px 6px 2px;">出票加速：极速优先处理订单</p>
				                    <p class="info_icon1 fl" style="margin:6px 5.5px 2px;">人工服务：提供人工退票</p>
				                    <dl class="select">
										<dt id="content_bx">20元保额65万</dt>
										<dd>
											<ul>
												<li><span>20元保额65万</span></li>
												<li><span>10元保额20万</span></li>
				                ...
				                <div class="info_txt2" id="normal_service">
				                    ...
				                    <p class="info_icon2">服务提醒：不提供人工退票</p>
