            ...
            <div class="ser_term oz">
              ...
              <div class="ser_result">  
                <table cellpadding="0" cellspacing="0">
                    <tr class="tit">
                        <th width="10%">车次/车型</th>
                        <th width="16%">发站/到站</th>
                        <th width="10%">发车/到达</th>
                        <th width="12%">运行时间</th>
	                    	...
	                    	<c:if test="${!empty list.station_train_code}">
	                    		<tr class="trainBar" id="${list.train_no}_ticket_${fn:substring(list.station_train_code, 0, 1)}_${tn:fromTimeStr(list.start_time)}_${tn:toTimeStr(list.arrive_time)}" startTime="${list.start_time}">
			                        ...
			                        <td class="seat">
				                        ...
				                        <c:if test="${list.gws ne '-'}"><p>高级软卧<span>￥${list.gws}/${list.gwx} [${list.gr_num_show}]</span></p></c:if>
				                        <c:if test="${list.tdz ne '-'}"><p>特等座<span>￥${list.tdz} [${list.tz_num_show}]</span></p></c:if>
				                        <c:if test="${list.swz ne '-'}"><p>商务座<span>￥${list.swz} [${list.swz_num_show}]</span></p></c:if>
			                        </td>
	                        		<c:choose>
