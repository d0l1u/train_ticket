...
//		orderDao.updateOrder(refund.getOrder_id());
	...
	public Map<String, Object> queryAgentOrderNum(Map<String, Object> map) {
		return orderDao.queryAgentOrderNum(map);
	}

	@Override
	public Map<String, Object> queryAgentRefundNum(Map<String, Object> map) {
		return orderDao.queryAgentRefundNum(map);
	}

	@Override
	public String selectRefundPassengers(String cpId) {
		return orderDao.selectRefundPassengers(cpId);
	}
