...
public class BuyTicketBase extends BaseController {
	...
	@Value("#{propertiesReader[INTERFACE_12306_URL]}")
	protected String interface_12306_url;//12306接口
	
	@Value("#{propertiesReader[INTERFACE_12306_NEW_URL]}")
	protected String interface_12306_new_url;//12306接口
