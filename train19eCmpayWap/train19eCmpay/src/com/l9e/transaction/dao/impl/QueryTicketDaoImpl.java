...
public class QueryTicketDaoImpl extends BaseDao implements QueryTicketDao {
	...
	public List<String> queryOftenStation() {
		return this.getSqlMapClientTemplate().queryForList("queryTicket.queryOftenStation");
	}

	@SuppressWarnings("unchecked")
	public List<Map<String, String>> queryOftenStationInfo(String station) {
		return this.getSqlMapClientTemplate().queryForList("queryTicket.queryOftenStationInfo", station);
	}
}
