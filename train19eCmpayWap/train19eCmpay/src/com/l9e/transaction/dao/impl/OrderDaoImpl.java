...
public class OrderDaoImpl extends BaseDao implements OrderDao {
	...
	public List<String> queryPassengerList(String orderId) {
		return this.getSqlMapClientTemplate().queryForList("order.queryPassengerList", orderId);
	}

	public void updateRefundStream(Map<String, String> paramMap) {
		this.getSqlMapClientTemplate().update("order.updateRefundStream", paramMap);
