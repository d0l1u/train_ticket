...
<body>
	<div class="content oz">
        ...
        <li>
          ...
          <p><img src="/images/book1.png" width="540"  alt="订票1" /></p>
          <p><img src="/images/book2.png" width="540" alt="订票二" /></p>
          <p>②进入订购页面后,录入详细的订购信息，点击“提交”按钮:</p>
          <p><img src="/images/book3.png" width="540" alt="订票--录入信息" /></p>
          
          <p>③到支付页面进行支付，完成订票。</p>
          <p><img src="/images/pay1.png" width="540" alt="订票-支付" /></p>
          <p><img src="/images/pay2.png" width="540" alt="订票-支付" /></p>
          
        </li>
        <li>
          <h3>2.火车票---购买保险</h3>
          <p>购票时是否购买保险由用户自行决定，绝无强制行为.保险现有种类：10元保20万、20元保65万，乘客在订票过程中可自行选择是否购买，保险预定成功后会给用户下发短信。</p>
          <p><img src="/images/insure1.jpg" width="540" alt="购买保险选择" /></p>
          <p>若需索取保险发票,请在订票过程中勾选”保险发票”选项。</p>
          <p><img src="/images/insure2.jpg" width="540" alt="勾选保险发票" /></p>
        ...
        <li>
          ...
          <p><img src="/images/ser-pic1.jpg" width="540" alt="查询订单" /></p>
        </li>
        <li>
          <h3>4.火车票---退票申请</h3>
        </li>
        <li>
          ...
          <p>①查询订单</p>
          <p><img src="/images/refund1.jpg" width="540" alt="退票--查询" /></p>
          <p>②退票操作</p>
          <p><img src="/images/refund2.jpg" width="540" alt="退票--退票" /></p>
          <p>打开退票页面后，找到退款小票上传处，点击“浏览”将退款小票上传，最后点击“提交”即可。</p>
          <p><img src="/images/refund3.jpg" width="540" alt="退票--退票>提交" /></p>
        </li>
        <li>
          <h3>5.火车票---投诉建议</h3>
          <p>若您在业务使用过程中,有不满意的地方或者宝贵的建议,请点击导航栏中的“投诉/建议”,留下您的想法</p>
          <p><img src="/images/complaint1.jpg" width="540" alt="投诉" /></p>
        </li>
        <li>
          <h3>6.火车票---帮助</h3>
          <p>若您在业务使用过程中,有不熟悉的地方,请点击导航栏中的“帮助”</p>
          <p><img src="/images/help1.jpg" width="540" alt="帮助" /></p>
        </li>
      </ul>
          </div>
