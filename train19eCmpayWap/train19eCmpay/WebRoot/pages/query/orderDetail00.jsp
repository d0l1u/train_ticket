	...
	<div class="wrap">
		...
		<section id="order_main">
			...
			<div class="order_con">
				<!-- 车票信息 -->
				<dl class="order_item">
					<dt class="text_item_header">订单信息<!-- <a href="" class="order_ticket_s">取票退票说明</a> --></dt>
					<dd line-height="30px">
					<c:choose>
			  ...
			  <!-- 订单状态 -->
				<dl class="order_status">
					...
					<c:choose>
						...
						<c:when test="${orderInfo.order_status eq '45'}"><!-- 购票失败 -->
