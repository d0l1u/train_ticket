...
public class TrainConsts {
	//高铁管家的合作商户编号
	public static final String GT_MERCHANT_ID="301030";
	public static final String GT_MERCHANT_ID_TEST="3010301";
	public static final String PARTNER_ID="train_19e";
	public static final String QUERY_TRAIN_TIME="http://43.241.224.121:8091/RunScript";
	/**
	 * session中存放用户的KEY
	 */
	...
	/********************订单支付类型***************************************/
	public static final String ORDER_PAY_TYPE_11 = "11";//自动代扣
	public static final String ORDER_PAY_TYPE_22 = "22";//商户自行扣费
	public static final String ORDER_PAY_TYPE_33 = "33";//支付宝代扣
	public static final String ORDER_PAY_TYPE_44 = "44";//支付宝连接
	...
	/********************订单处理结果异步通知状态类型***************************************/
	public static final String ORDER_RESULT_22 = "22";//通知完成
	public static final String ORDER_RESULT_44 = "44";//通知失败
	...
	public static final String OUT_FAIL_REASON_9 = "9";//系统异常
	public static final String OUT_FAIL_REASON_10 = "10";//乘客被高消费限制
	public static final String OUT_FAIL_REASON_11 = "11";//超时未支付
	public static final String OUT_FAIL_REASON_12 = "12";//信息冒用
	
	public static final String OUT_FAIL_REASON_13 = "13";//排队人数过多时，高铁管家要求批量失败
	
	/********************出票失败原因NEW code***************************/
	/*
	   	1001	证件信息错误，请再次核对后重新购买。-->5
	 	1002	未通过12306实名认证，请持本人身份证到火车站或售票窗口完成身份核验。-->7
		1003	身份信息被冒用，请持本人身份证到火车站或售票窗口完成身份核验。-->12
		1004	身份信息待核验，您可以持本人身份证到火车站或售票窗口完成身份核验。-->8
		1005	票已售完，所购买的车次对应坐席已无票-->
		1006	所买车票张数超过余票张数-->1
		1007	您已经购买当日当次列车车票，或者有当日当次列车订单-->2
		1008	抱歉，车次信息异常，购票款将全额退还至您的原支付账户。-->4
		1009	乘客被限制购买此种车票-->10
		1010	您所购的车票，排队人数过多，请稍后重试-->
		1011	抱歉，管家代购失败了，购票款将全额退还至您的原支付账户。-->	其他
	 */
	
	public static final String OUT_FAIL_CODE_1001 = "1001";//证件信息错误，请再次核对后重新购买。
	public static final String OUT_FAIL_CODE_1002 = "1002";//未通过12306实名认证，请持本人身份证到火车站或售票窗口完成身份核验。
	public static final String OUT_FAIL_CODE_1003 = "1003";//身份信息被冒用，请持本人身份证到火车站或售票窗口完成身份核验。
	public static final String OUT_FAIL_CODE_1004 = "1004";//身份信息待核验，您可以持本人身份证到火车站或售票窗口完成身份核验。
	public static final String OUT_FAIL_CODE_1005 = "1005";//票已售完，所购买的车次对应坐席已无票
	public static final String OUT_FAIL_CODE_1006 = "1006";//所买车票张数超过余票张数
	public static final String OUT_FAIL_CODE_1007 = "1007";//您已经购买当日当次列车车票，或者有当日当次列车订单
	public static final String OUT_FAIL_CODE_1008 = "1008";//抱歉，车次信息异常，购票款将全额退还至您的原支付账户。
	public static final String OUT_FAIL_CODE_1009 = "1009";//乘客被限制购买此种车票
	public static final String OUT_FAIL_CODE_1010 = "1010";//您所购的车票，排队人数过多，请稍后重试
	public static final String OUT_FAIL_CODE_1011 = "1011";//抱歉，管家代购失败了，购票款将全额退还至您的原支付账户。
	public static final String OUT_FAIL_CODE_1018 = "1018";//票价和12306不符
	...
	private static Map<String, String> FAIL_REASON_CODE = new HashMap<String, String>();//出票失败原因new
	...
	static {
		...
		1008	抱歉，车次信息异常，购票款将全额退还至您的原支付账户。-->4
		1009	乘客被限制购买此种车票-->10
		1010	您所购的车票，排队人数过多，请稍后重试-->13
		1011	抱歉，管家代购失败了，购票款将全额退还至您的原支付账户。-->9、	其他
		1018	票价和12306不符。-->3
	 */
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_5,  OUT_FAIL_CODE_1001);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_7,  OUT_FAIL_CODE_1002);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_12,  OUT_FAIL_CODE_1003);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_8,  OUT_FAIL_CODE_1004);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_1,  OUT_FAIL_CODE_1006);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_2,  OUT_FAIL_CODE_1007);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_4, OUT_FAIL_CODE_1008);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_10,  OUT_FAIL_CODE_1009);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_9, OUT_FAIL_CODE_1011);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_13, OUT_FAIL_CODE_1010);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_3, OUT_FAIL_CODE_1018);
		...
		FAIL_REASON.put(OUT_FAIL_REASON_9, "系统异常");
		FAIL_REASON.put(OUT_FAIL_REASON_10, "乘客被高消费限制");
		FAIL_REASON.put(OUT_FAIL_REASON_11, "订单超时未支付。");
		FAIL_REASON.put(OUT_FAIL_REASON_12, "乘客的身份信息涉嫌被他人冒用，请您持本人身份证件，到就近办理客运售票业务的铁路车站完成身份核验。");
		
		FAIL_REASON.put(OUT_FAIL_REASON_13, "您所购的车票，排队人数过多，请稍后重试。");
		
		EXTBOOKSTATUS.put(PAY_SUCCESS, "BOOKING");
		EXTBOOKSTATUS.put(BOOKING_TICKET, "BOOK_SUCCESS");
	...
	public static Map<String, String> getOutFailReasonCode(){
