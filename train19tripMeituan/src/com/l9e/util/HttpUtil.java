...
public class HttpUtil {
	 ...
	 * @return
	 */
	public static String sendByPostVerify(String url, String params, String inputCharset,int readTimeOut,int ConnectTimeOut) {
	 ...
	 * @return
	 */
	public static String sendByPost(String url, String params, String inputCharset,int readTimeOut,int ConnectTimeOut) {
