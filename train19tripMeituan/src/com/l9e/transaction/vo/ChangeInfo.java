...
public class ChangeInfo {
	 ...
	 * 美团改签id
	 */
	private String mt_change_id;
	/**
	 * 改签记录所改签的车票
	 */
	private List<ChangePassengerInfo> cPassengers;
	...
	public List<ChangePassengerInfo> getcPassengers() {
		return cPassengers;
	}

	public void setcPassengers(List<ChangePassengerInfo> cPassengers) {
	...
	public String getMt_change_id() {
		return mt_change_id;
	}

	public void setMt_change_id(String mtChangeId) {
		mt_change_id = mtChangeId;
	}
