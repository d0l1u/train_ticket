...
public class DBOrderInfo {
	...
	private String order_type;//订单类型  11、先预订后支付 22 先支付后预订
	...
	private String lock_callback_url;//锁票异步回调地址
	
	public String getLock_callback_url() {
		return lock_callback_url;
	}
	public void setLock_callback_url(String lockCallbackUrl) {
		lock_callback_url = lockCallbackUrl;
	}
