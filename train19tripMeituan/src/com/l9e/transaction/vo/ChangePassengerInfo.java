...
public class ChangePassengerInfo {
	 ...
	 * 美团改签后坐席类别
	 */
	private String mt_change_seat_type;
	...
	public String getMt_change_seat_type() {
		return mt_change_seat_type;
	}

	public void setMt_change_seat_type(String mtChangeSeatType) {
		mt_change_seat_type = mtChangeSeatType;
	}
