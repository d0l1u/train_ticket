...
public class BaseController {
	 ...
	 * @return String
	 */
	public String queryMeituanSysValueByName(String setting_name){
		String value = null;
		if(null == MemcachedUtil.getInstance().getAttribute(setting_name)){
			value = commonService.queryMeituanSysValueByName(setting_name);
			MemcachedUtil.getInstance().setAttribute(setting_name, value, 5*60*1000);
			
		}else{
			value = (String) MemcachedUtil.getInstance().getAttribute(setting_name);
		}
		return value;
	}
	 ...
	 * @return String
	 */
	public String queryMeituanSysValueByName(String setting_name,long time){
		String value = null;
		if(null == MemcachedUtil.getInstance().getAttribute(setting_name)){
			value = commonService.queryMeituanSysValueByName(setting_name);
			MemcachedUtil.getInstance().setAttribute(setting_name, value, time);
