...
public class TrainConsts {
	...
	private static Map<String, String> WHITEPERSONTYPE = new HashMap<String, String>();//白名单票种类型说明
	//初始化
	static {
		...
		WHITEPERSONTYPE.put("1", "成人票");//联系人类型：1成人 2儿童 3学生
		WHITEPERSONTYPE.put("2", "儿童票");
		WHITEPERSONTYPE.put("3", "学生票");
		WHITEPERSONTYPE.put("4", "残军票");
	}
	
	public static Map<String,String> getWhitePersonType(){
		return WHITEPERSONTYPE;
	}
