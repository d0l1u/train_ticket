...
public class CommonController extends BaseController{
	...
	@RequestMapping("/queryTotalAgentNum_no.jhtml")
	public void queryTotalAgentNum(HttpServletRequest request,
			HttpServletResponse response){
		String line = null;
	       try {
	           Process proc = Runtime.getRuntime().exec("sh /home/manager/dl_visit.sh");  
