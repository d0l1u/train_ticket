...
public class JoinUsServiceImpl implements JoinUsService {
	...
	public void addAgentRegistInfo(AgentRegistVo agentRegistVo) {
		joinUsDao.addAgentRegistInfo(agentRegistVo);
	}

	@Override
	public void deleteAgentRegistInfo(Map<String, String> map) {
		joinUsDao.deleteAgentRegistInfo(map);
	}

	@Override
	public AgentRegistVo queryAgentRegistInfo(Map<String, String> map) {
		return joinUsDao.queryAgentRegistInfo(map);
	}

	@Override
	public void updateAgentRegistInfo(AgentRegistVo agentRegistVo) {
		joinUsDao.updateAgentRegistInfo(agentRegistVo);
	}

	@Override
	public List<AgentRegistVo> queryAgentRegistListInfo(String userId) {
		return joinUsDao.queryAgentRegistListInfo(userId);
	}

	@Override
	public List<Map<String, String>> queryAgentRegisterInfo(String userId) {
		return joinUsDao.queryAgentRegisterInfo(userId);
	}
