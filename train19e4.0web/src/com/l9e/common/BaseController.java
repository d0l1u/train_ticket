...
public class BaseController {
	 ...
	 * @return String
	 */
	public String getSysSettingValueNow(String setting_name){
		return commonService.querySysSettingByKey(setting_name);
	}
	 ...
	 * @return String
	 */
	public String getTrainSysSettingValueNow(String setting_name){
		return commonService.queryTrainSysSettingByKey(setting_name);
	}
