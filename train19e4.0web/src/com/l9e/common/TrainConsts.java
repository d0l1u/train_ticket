...
public class TrainConsts {
	...
	public static final String PAYING = "01";//正在支付	
	...
	public static final String PRE_BOOK = "77";//预约购票
	public static final String CANCLE_BOOK ="78";//取消预约
	
	public static final String PS_ING = "P1";//配送中
	public static final String PS_SUCCESS = "P2";//配送成功
	public static final String PS_FAILURE ="P3";//配送失败
	...
	public static final String REFUND_TYPE_6 = "6";//电话退票
	public static final String REFUND_TYPE_7 = "7";//取消预约退款
	public static final String REFUND_TYPE_8 = "8";//线下退款
	...
	public static final String TICKETTYPE_STUDENT = "3";
	...
	private static final String SEAT_20 = "20";
	...
	public static final String OUT_TICKET_TYPE_PSSM = "33";//配送票
	...
	public static final String OUT_FAIL_REASON_12 = "12";//乘客身份信息被冒用
	...
	static {
		...
		BOOKSTATUS.put(PRE_BOOK, "预约购票");//预约购票 
		BOOKSTATUS.put(CANCLE_BOOK, "取消预约");//取消预约
		
		BOOKSTATUS.put(PS_ING, "配送中");//配送中
		BOOKSTATUS.put(PS_SUCCESS, "配送成功");//配送成功
		BOOKSTATUS.put(PS_FAILURE, "配送失败");//配送失败
		
		REFUND_STREAM_STATUS.put(REFUND_STREAM_PRE_REFUND, "退款申请中");//准备退款
		REFUND_STREAM_STATUS.put(REFUND_STREAM_GEZHI, "退款申请中");//搁置订单
		...
		REFUND_TYPE.put(REFUND_TYPE_7, "取消预约退款");
		...
		FAIL_REASON.put(OUT_FAIL_REASON_12, "身份信息被冒用，请持本人身份证到火车站或售票窗口完成身份核验。");
	}
