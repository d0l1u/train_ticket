            ...
            <!--订单号查询模块 end-->
         	<div class="debook oz">
            	<h2>
                	...
                	<span class="nav_mid_bg">订单详情 &nbsp;&nbsp;<font style="color:red;padding-left:80px;font-weight:none;font-size:12px;">请提示用户：若使用临时身份证取票，必须同时提供12306订单号，方可取票！</font></span>
                ...
                <table>
                	...
                	<c:forEach items="${orderList}" var="order" varStatus="idx">
	                    ...
	                    <tr class="order_num_state">
	                		...
	                		<td nowrap="nowrap">
	                			<font style="font-weight:bold;color:red;padding-right:45px;"><fmt:formatNumber value="${order.ticket_pay_money + order.bx_pay_money}" type="currency" pattern="#0.00"/></font>
	                			&nbsp;<font style="cursor:hand;position:absolute;_margin-top:-15px;*margin-top:-15px;left:220px;" id="price${idx.index+1}" onclick="showOrHide(${idx.index+1},${order.pay_money})">[显示]</font>	
	                		</td>
	                		...
	                		<td>
	                			<c:if test="${order.order_status eq '44'}">
									<input type="button" class="btn" value="打印" onclick="_printIT('${order.order_id}');" />	                				
	                			</c:if>
	                		</td>
	                	</tr>
