...
<body>
	<div class="content oz">
    	...
    	<div class="left_con oz">
            ...
            <p class="price_tip">温馨提醒：提前30天预约购票功能仅为VIP、SVIP订单专享，在平台预约购票后待铁路系统发售时订购，我们会将购票结果短信通知乘客。</p>
            <!-- 
		                ...
		                <dl class="oz">
		                    ...
		                    <dd><input class="text text2" type="text" id="travel_time" name="travel_time" 
		                    		value="${paramMap.travel_time}" readonly="readonly" 
							  		onfocus="WdatePicker({doubleCalendar: true ,dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d',maxDate:'%y-%M-{%d+29}'})" /></dd>
		                </dl>
		            </div>
                    <div class="notice oz">
                ...
                <table>
                    ...
                    <c:forEach items="${otVo.dataList}" var="list">
		                    <tr id="${list.id}_ticket_${fn:substring(list.trainCode, 0, 1)}_${tn:fromTimeStr(list.startTime)}_${tn:toTimeStr(list.endTime)}" class="trainBar" startTime="${list.startTime}">
		                        ...
		                        <td class="adr">
		                        	<span id="${list.id}_${list.startCity}" class="start">${list.startCity}</span><br/>
		                        	<span class="end" id="${list.id}_${list.endCity}">${list.endCity}</span>
		                        </td>
