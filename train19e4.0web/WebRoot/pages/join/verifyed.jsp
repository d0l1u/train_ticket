	...
	<div class="index_all">
    	...
    	<div class="infoinput-right oz">
            ...
            <div class="join_us oz" style=" height:650px;">
             	  <c:if test="${(realPass eq '1' && agentVo.estate eq '11') or (realPass eq '1' && agentVo.estate eq '22') or realPass eq '0' }">
	           	   <div class="agent_pass oz">
		            	<ul class="agent_pass_ul" >
		                	<li class="current1"><a href="/joinUs/agentInfoIndex.jhtml">个人信息</a></li>
		                	<li class="current current1"><a href="/joinUs/joinIndex.jhtml">我要开通</a>
