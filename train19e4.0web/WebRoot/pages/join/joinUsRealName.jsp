	...
	<div class="index_all">
    	...
    	<div class="infoinput-right oz">
            ...
            <div class="join_us oz">
                ...
                <!--身份证实名 start-->
                <form action="/joinUs/firstSubmitRegistInfo.jhtml" method="post" id="personForm">
               	<div class="id-verify oz">
                    ...
                    <div class="submit-id oz">
                    	<div class="protocol oz">
                        	<input type="checkbox" id="weather_agree" checked="checked"/>
                        ...
                        <div class="operate-btn oz" style="margin-left:60px;">
                        	<input type="submit" class="btn submit" value="提交审核" />
                        	<input type="submit" class="btn submit" value="以后再说" />
                        </div>
                    </div>
                </div>
                </form>
