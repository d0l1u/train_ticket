	...
	<div class="content oz">
        ...
        <div class="yew_l_con oz">
        	<div class="left_nav">
            	<h2>业务介绍</h2>
            	<ul>
                    <li class="current"><a href="protocol.jsp">火车票线下代购服务协议</a></li>
        ...
        <div class="yew_r_con oz"><!-- InstanceBeginEditable name="EditRegion3" -->
          ...
          <div class="con_con">
            ...
            <ul>
              ...
              <li><h3>五、免责条款</h3></li>
              <li><p>1、一九易火车票业务禁止代理商向用户收取票面价格以外的服务费用，如果因此类费用发生纠纷和一九易公司没有任何关系。</p>
              <li><p>2、一九易禁止代理商在未征得用户允许的情况向用户出售火车保险，如果因此发生的服务纠纷和一九易公司没有任何关系。</p>
              <li><p>3、在系统服务期间，一九易将有权根据需要，随时对产品的服务内容进行更新或删除，且无需另行通知或取得代理商的同意。</p>
              </li>
              <li><p>4、一九易提供的火车票信息、列车时刻信息、客票余额信息、座位信息、票价等信息全部来自互联网，在代购的火车票的车次、票价、始发时间、到站时间等以实际为准，本公司对此等信息的准确性、完整性、合法性或真实性均不承担责任。
              </p></li>
              <li><p>5、一九易提供的是火车票代购服务，您接受本协议代表您已经同意我们使用您所填写的乘客信息进行代购，包括但不仅限于授权我们使用您的乘客信息创建12306帐号，同时您必须遵守12306的购票规定的服务条款（<a style="color:blue;font-size:12px;" href="https://kyfw.12306.cn/otn/regist/rule">https://kyfw.12306.cn/otn/regist/rule</a>），对于您违反《火车票线下代购服务协议》
所引起的争议和法律问题，由您自行承担。
              </p></li>
               <li><h3>六、其他</h3></li>
              </li>
