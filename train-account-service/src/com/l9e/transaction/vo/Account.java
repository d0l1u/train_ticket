...
public class Account implements Serializable {
	...
	public Byte getRealCheckStatus() {
		return realCheckStatus;
	}

	public void setRealCheckStatus(Byte realCheckStatus) {
	...
	public Byte getRealContactNum() {
		return realContactNum;
	}

	public void setRealContactNum(Byte realContactNum) {
		this.realContactNum = realContactNum;
	}
	...
	public String toString() {
		return "Account [bookNum=" + bookNum + ", channel=" + channel
				...
				+ stopReason + ", username=" + username + ", realCheckStatus="
				+ realCheckStatus + ", realReceive=" + realReceive + ", realContactNum=" + realContactNum + "]";
	}
