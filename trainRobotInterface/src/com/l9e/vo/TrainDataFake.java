...
public class TrainDataFake implements Serializable {
	...
	private String dws_price; //动卧上票价
	private String dwx_price; //动卧下票价
	...
	public String getDws_price() {
		return dws_price;
	}

	public void setDws_price(String dws_price) {
		this.dws_price = dws_price;
	}
