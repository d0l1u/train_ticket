...
public class TrainNewData implements Serializable {
	...
	public void setGw_num(String gwNum) {//gw,gr都为高级软卧
		this.gw_num=this.getGr_num();
	}
	...
	public void setTz_num(String tzNum) {
		...
		this.setTdz_num(tz_num);
	}
	
	public void setTdz_num(String tdz_num) {
		this.tdz_num = this.getTz_num();
	}
