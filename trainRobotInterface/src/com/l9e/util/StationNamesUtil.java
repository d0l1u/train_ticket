...
public class StationNamesUtil {
	...
	private static String station_ = "/station_name.js"; 
	public static Map<String,String> stationName=null;
	static{
		stationName=new HashMap<String,String>();
		try {
			BufferedInputStream bufferedInputStream=new BufferedInputStream(StationNamesUtil.class.getResourceAsStream(station_));
...
//		    	System.out.println("key:"+keyValue[1]+"__value:"+keyValue[2]);
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException{
		String m = getValueFromStationName(null);
		if (null == m){
			System.out.println(m);
		}
		
		
//		String str = "{\"validateMessagesShowId\":\"_validatorMessage\",\"status\":true,\"httpstatus\":200,\"messages\":[],\"validateMessages\":{}}";
//		ObjectMapper mapper = new ObjectMapper();
//		TrainReturnData outer12306NewData = mapper.readValue(str, TrainReturnData.class);
