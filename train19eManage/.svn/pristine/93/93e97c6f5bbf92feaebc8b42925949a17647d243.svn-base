...
<body>
	...
	<form action="/appRefund/refundStationTicketAdd.do" method="post" name="updateForm" id="updateForm" onsubmit="return checkSubmit();">
        <ul class="order_num oz">
            ...
            <li>退款金额：&nbsp;<input type="text" name="refund_money" id="refund_money" style="width: 213px;"
