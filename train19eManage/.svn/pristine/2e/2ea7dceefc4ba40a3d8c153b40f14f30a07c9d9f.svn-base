...
public class MeituanVo {
	...
	public static final String FAIL_REASON_401 = "401";
	public static final String FAIL_REASON_403 = "403";
	...
	/*
	 * 401、请求时间已超时，出票失败403  账户余额不足301 、没有余票305乘客已经预定过该车次308、乘客身份信息未通过验证
	309、没有足够的票310本次购票与其他订单行程冲突313、12306提示其他异常
	 */
	...
	public static Map<String, String> getAlertFailReason() {
		if(ALTERFAILREASON.isEmpty()) {
			ALTERFAILREASON.put(FAIL_REASON_401, "请求时间已超时，出票失败");
			ALTERFAILREASON.put(FAIL_REASON_403, " 账户余额不足");
			ALTERFAILREASON.put(FAIL_REASON_301, "没有余票");
			ALTERFAILREASON.put(FAIL_REASON_305, "乘客已经预定过该车次");
			ALTERFAILREASON.put(FAIL_REASON_308, "乘客身份信息未通过验证");
			ALTERFAILREASON.put(FAIL_REASON_309, "没有足够的票");
			ALTERFAILREASON.put(FAIL_REASON_310, "本次购票与其他订单行程冲突");
			ALTERFAILREASON.put(FAIL_REASON_313, "12306提示其他异常");
		}
