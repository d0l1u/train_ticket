...
public interface TuniuRefundDao {
	...
	List<Map<String, String>> queryTuniuMerchantinfo();

	void updateTuniuRefundNotifyNum(Map<String, String> paramMap);

	String queryRefundStationTicketAdd(Map<String, Object> mapAdd);
	...
	void updateTuniuRefundNotifyStatus(Map<String, Object> refundMap);
	...
	void addRefundStationTicketNotify(Map<String, Object> mapAdd);

	String queryMerchantIdByOrderId(Map<String, Object> pMap);

	List<Map<String, String>> queryTicketCpId(Map<String, Object> paramMap);

	String queryCpSumRefundMoney(Map<String, Object> paramMap);

	List<Map<String, String>> queryCpBuyAndPayMoney(Map<String, Object> paramMap);
	String queryRefundTime(Map<String,Object> param);
