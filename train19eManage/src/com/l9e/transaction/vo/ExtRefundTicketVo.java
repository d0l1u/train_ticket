...
public class ExtRefundTicketVo {

	/*******************退款类型************************/
	//商户退款类型：1、用户线上退票 2、用户车站退票 3、改签单退款 4、差额退款 5、出票失败退款
	public static final String REFUND_USER = "1"; //用户线上退票
	public static final String REFUND_BALANCE ="2";//用户车站退票
	public static final String REFUND_PAY_DEFEATED ="3";//改签单退款
	public static final String REFUND_PAY_CHAE ="4";//差额退款
	public static final String REFUND_PAY_FAIL ="5";//出票失败退款
	...
	public static Map<String,String> getRefund_Types(){
		if(REFUNDTYPE_MAP.isEmpty()){
			...
			REFUNDTYPE_MAP.put(REFUND_BALANCE, "用户车站退票");
			REFUNDTYPE_MAP.put(REFUND_PAY_DEFEATED, "改签单退款");
			REFUNDTYPE_MAP.put(REFUND_PAY_CHAE, "差额退款");
			REFUNDTYPE_MAP.put(REFUND_PAY_FAIL, "出票失败退款");
		}
...
//	}
	...
	//00、等待退票 01：重新机器改签;02：开始机器改签;03：机器改签失败;04：等待机器退票；
	//05：重新机器退票；06：开始机器退票；07：机器退票失败；
	//11、同意退票 22、拒绝退票 33、退票完成 44、退票失败55:审核退款；99、搁置订单
	...
	public static String REFUND_STATUS_EOP = "33";//退票完成
	public static String REFUND_STATUS_ACHIEVE ="44";//退票失败
	public static String REFUND_STATUS_GEZHI = "99";//搁置订单
	
	public static String REFUND_STATUS_01 = "01";//重新机器改签
	public static String REFUND_STATUS_02 = "02";//开始机器改签
	public static String REFUND_STATUS_03 = "03";//机器改签失败
	public static String REFUND_STATUS_04 = "04";//等待机器退票
	public static String REFUND_STATUS_05 = "05";//重新机器退票
	public static String REFUND_STATUS_06 = "06";//开始机器退票
	public static String REFUND_STATUS_07 = "07";//机器退票失败
	public static String REFUND_STATUS_55 = "55";//审核退款
	...
	public static Map<String,String> getRefund_Status(){
		if(REFUNDSTATUS_MAP.isEmpty()){
			...
			REFUNDSTATUS_MAP.put(REFUND_STATUS_EOP, "退票完成");
			REFUNDSTATUS_MAP.put(REFUND_STATUS_ACHIEVE, "退票失败");
			REFUNDSTATUS_MAP.put(REFUND_STATUS_55, "审核退款");
...
//	}
	...
	//通知状态
	public static final String NOTIFY_00 = "00";//未通知
	public static final String NOTIFY_11 = "11";//准备通知
	public static final String NOTIFY_22 = "22";//开始通知
	public static final String NOTIFY_33 = "33";//通知完成
	...
	public static Map<String, String> getNotify_Status() {
		if(NOTIFY_STATUS.isEmpty()) {
			NOTIFY_STATUS.put(NOTIFY_00, "未通知");
			NOTIFY_STATUS.put(NOTIFY_11, "准备通知");
			NOTIFY_STATUS.put(NOTIFY_22, "开始通知");
			NOTIFY_STATUS.put(NOTIFY_33, "完成通知");
