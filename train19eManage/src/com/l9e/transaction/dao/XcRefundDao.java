...
public interface XcRefundDao {
	...
	List<Map<String, String>> queryXcMerchantinfo();

	void updateXcRefundNotifyNum(Map<String, String> paramMap);
	...
	void updateXcRefundNotifyStatus(Map<String, Object> refundMap);
