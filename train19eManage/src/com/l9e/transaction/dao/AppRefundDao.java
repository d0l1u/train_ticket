...
public interface AppRefundDao {
	...
	void updateRefundCpOrderInfo(Map<String, Object> map);

	void updateRefundCpOrderInfoRefuse(Map<String, Object> refuseMap);

	List<Map<String, String>> queryRefundTicketPhoneInfo(
			Map<String, String> idMap);

	void updateRefundStationTicketPhone(Map<String, Object> mapAdd);

	List<String> queryRefundStatus(String string);

	void updateNotifyStatus(Map<String, Object> refundMap);
