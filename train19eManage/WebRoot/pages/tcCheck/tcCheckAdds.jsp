...
<head>
		...
		function importExcel(){
			...
			if(confirm("确定上传？")){
			$("form:first").attr("action","/elongExcel/tcAddCheck.do?file="+file);
			$("form:first").submit();
			}
		}

		function goback(){
			$("form:first").attr("action","/elongExcel/tcAddCheckPage.do");
			$("form:first").submit();
		}
...
<body>
	<form action="/elongExcel/tcAddCheck.do" method="post" enctype="multipart/form-data" id="addForm" onsubmit="return checkSubmit();">
