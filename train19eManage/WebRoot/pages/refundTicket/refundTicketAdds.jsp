...
<head>
		...
		function importExcel(){
			...
			if(confirm("确认批量导入？")){
			$("form:first").attr("action","/refundTicket/addAllRefundStation.do?file="+file);
			$("form:first").submit();
			}
		...
		function goback(){
			$("form:first").attr("action","/refundTicket/queryRefundPage.do");
			$("form:first").submit();
		}
...
<body>
	<form action="/refundTicket/queryRefundTicketPage.do" method="post" enctype="multipart/form-data" id="addForm" onsubmit="return checkSubmit();">
