...
<html>
	<head>
		...
		<style type="text/css">
			 ...
			 .pub_debook_mes td{line-height:30px;}
			 .pub_table td{height:20px;}
		</style>
		 -->
	</head>
	<body>
		<div class="content oz">
			<form action="/complain/updateComplainInfo.do" method="post" id="updateForm">
				<input type='hidden' name='complain_id' value='${complainInfo.complain_id}' />
						...
						<div class="pub_con">
							<table class="pub_table" style="width: 500px; margin: 20px auto; border:1px solid #C0C0C0; " rules="rows" cellspacing=0>
								<c:forEach var="hs" items="${history}" varStatus="idx">
									...
									<tr>
									<td align="left" colspan="4" style="border-bottom:1px solid #ddd;line-height:20px;padding:0 10px 5px;">答复内容：
											${hs.our_reply}
										</td>
									</tr>
									<!-- 
