...
<script type="text/javascript">
	...
	function onblurOrderId(){
		...
		if(order_id==""){
			...
			var url = "/extRefund/queryRefundTicketAdd.do?order_id="+order_id;
...
<body>
	...
	<form action="/extRefund/refundTicketAdd.do" method="post" name="updateForm" id="updateForm" onsubmit="return checkSubmit();">
        <ul class="order_num oz">
        	<li>订&nbsp;单&nbsp;号：&nbsp;<input type="text" name="order_id" id="order_id"  
        	...
        	<li>
        		...
        		<select id="channel" name="channel" style="width:130px;">
        			<c:forEach items="${merchantList }" var="s" varStatus="index">
        				<option value="${s.merchant_id }">${s.merchant_name }</option>
        			</c:forEach>
        		</select>
        	</li>
