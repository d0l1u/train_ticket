...
<html>
	...
	<body><div></div>
        ...
        <p>
			...
			<%if(username.equals("libx") || username.equals("xuli") || username.equals("guona")|| username.equals("zhangjc") ||username.equals("zuoyunxia") ){ %>
					...
					<table>
						...
						<c:forEach var="list" items="${fileList}" varStatus="idx">
							...
							<td>
								...
								<%if(username.equals("libx") || username.equals("zhangjc") || username.equals("xuli") || username.equals("guona") | username.equals("zuoyunxia")){ %>
