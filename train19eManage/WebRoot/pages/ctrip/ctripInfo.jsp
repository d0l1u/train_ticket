			...
			<div class="left_con oz">
					...
					<div class="pub_con">
						<table class="pub_table" >
							<tr>
								...
								<td>
									订单状态：
									<span>${manualStatus[orderInfo.go_status] } </span>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>
									...
									<span> 
									<c:choose>
										<c:when test="${orderInfo.go_status ne '82'}">
										<c:choose>
							...
							<tr>
							<c:if test="${orderInfo.go_status eq '10'}">
								<c:choose>
				...
				<div class="pub_order_mes  oz mb10_all">
					...
					<div class="pub_con">
						<table class="pub_table"  style="width:90%;">
							...
							<c:choose>
								<c:when test="${fn:contains('82,MM', orderInfo.go_status)}">
									<tr>
										<td colspan="2">
							 ...
							 <tr>
								<!-- 明细中显示12306单号 -->
								<td>
									<c:if test="${fn:contains('88,10,99', orderInfo.go_status)}">
									12306单号：
				...
				<div class="pub_passager_mes oz mb10_all">
					...
					<div class="pub_con">
						<c:forEach var="cp" items="${cpList}" varStatus="idx">
							...
							<c:if test="${cp.buyMoney > cp.payMoney}">
								...
								<c:if test="${fn:contains('82,MM', orderInfo.go_status)}">
									<tr>
										<td width="234">
											<span>
						...
						<input type="hidden" name="go_status" id="go_status" />
					<c:if test="${fn:contains('MM,88,99,10', orderInfo.go_status)}">
							<div class="pub_passager_mes oz mb10_all">
								<h4>
									出票账号
								</h4>
								<div class="pub_con">
									...
									<table class="pub_table">
										...
										<c:if test="${orderInfo.acc_id eq null || orderInfo.acc_id eq ''}">
											<c:if test="${orderInfo.go_status eq 'MM' && query_type eq '2'  }">
												<td>
						...
						<c:if test="${fn:contains('82', orderInfo.go_status)}">
							<div class="pub_passager_mes oz mb10_all">
								<h4>
									人工付款
								</h4>
						...
						<c:if test="${fn:contains('MM', orderInfo.go_status)}">
							<div class="pub_passager_mes oz mb10_all">
								<h4>
									人工付款
								</h4>
					...
					<div class="pub_debook_mes  oz mb10_all">
						<p>
							<c:if test="${orderInfo.go_status eq 'MM' && canOperation!=1}">
							...
							<c:if test="${orderInfo.go_status eq '82'}">
