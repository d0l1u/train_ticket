...
<html>
	...
	<body>
		<div class="book_manage oz">
			<form action="/robotSet/queryRobotSetList.do" method="post" name="myform" id="myform">
				...
				<c:if test="${!empty isShowList}">
					<table>
						...
						<tr style="background:#E0F3ED; ">
							<td>
								${idx.index+1}
							<input type="hidden" class="text" name="robot_id" value="${robot_id }" />
							</td>
							<td>
								${list.robot_name }
							</td>
