...
<script type="text/javascript">
	...
	function switch_ignore(refund_deadline_ignore){
		if(confirm("确认切换无视退款时间？")){
			window.location='/innerBooking/updateInnerSwitch_ignore.do?order_id=${orderInfo.order_id}&refund_deadline_ignore='+refund_deadline_ignore;
		}
	}
         	...
         	<div class="pub_order_mes oz mb10_all">
                ...
                <div class="pub_con">
                	<table class="pub_table">
                        ...
                        <tr>
                        	<td width="234">付款账号：<span>${orderInfo.user_id}</span></td>
                        	<td width="234">渠&nbsp;&nbsp;&nbsp;&nbsp;道：<span>${innerChannels[orderInfo.inner_channel]}</span></td>
                        </tr>
                          <tr>
                ...
                <div class="pub_con">
                	<table class="pub_table">
                        ...
                        <tr>
                          ...
                          <tr>
                        	<td>票价 ：<span style="font-weight: bold;color: red;">${orderInfo.ticket_pay_money}</span> 元
                        	保 险：<span style="font-weight: bold;color: red;">${orderInfo.bx_pay_money}</span> 元</td>
                        	<td>
                        	
                        	配 送：<span style="font-weight: bold;color: red;">${orderInfo.ps_pay_money }</span> 元
