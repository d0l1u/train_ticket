...
<script type="text/javascript">
	...
	function onblurOrderId(){
		...
		if(order_id==""){
			...
			var url = "/jdRefund/queryRefundTicketAdd.do?order_id="+order_id+"&version="+new Date();
	...
	function onblurCpId(){
		...
		if(cp_id==""){
			...
			var url = "/jdRefund/queryRefundTicketCpId.do?cp_id="+cp_id+"&order_id="+order_id+"&version="+new Date();
			$.get(url,function(data){
				if(data == "no"){
	...
	function onblurRefundMoney(){
		...
		if(refund_money==""){
			...
			//alert(refundMoney);
			var url = "/jdRefund/queryRefundMoney.do?orderId="+orderId+"&cpId="+cpId+"&refundMoney="+refundMoney+"&version="+new Date();
			$.get(url,function(data){
				if(data == "no" ){
