...
public class MobileMsgUtil {
	...
	public boolean sendByDxyd(String phoneNo, String content){
		...
		String contentStr = new String(content+"【酷游旅游】").replace(" ", "");
		String sendContent = "";
		try {
	 ...
	 * @param content
	 */
	public static boolean sendByQyt(String phoneNo, String content){
		String contentStr = new String("【酷游旅游】"+content).replace(" ", "");
		String sendContent = "";
		try {
			sendContent = URLEncoder.encode(contentStr, "GBK");
		} catch (UnsupportedEncodingException e) {
