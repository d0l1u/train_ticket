...
public class HttpClientUtil {
	...
	/**
	 * 查询字符串转换成Map<br/> name1=key1&name2=key2&...
	 * 
	 * @param queryString
	 * @return
	 */
	...
	/**
	 * BufferedReader转换成String<br/> 注意:流关闭需要自行处理
	 * 
	 * @param reader
	 * @return String
	 * @throws IOException
	...
	public static void storeCACert(Certificate cert, String alias,
		...
		try {
			...
			logger.error("load KeyStore发生异常：" + e);
		}
