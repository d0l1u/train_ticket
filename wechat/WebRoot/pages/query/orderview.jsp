...
<!-- 展示票据信息 -->
<div id="print_small" >
<div class="center" style="margin:auto;height:360px; width:320px; border:2px solid #333;">
		...
		<div class="font14 center yahei" style="height:20px;padding-top:8px;">
	 	...
	 	<div class="dotDiv" style="height:1px;padding:0px;"></div>
	 	<div class="font14 center yahei" style="padding:15px 0 0px;height:20px;">
	 	...
	 	<div class="font14 center yahei" style="padding-top:8px;height:20px;">
	 		<div style="float:left;width:90px;text-align:right;">价 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</div>
	   	...
	   	<div class="font14 left yahei" style="padding-top:15px;padding-bottom:30px;">
...
<div class="center" style="margin:auto;float:center; width:216px; height:320px;border:2px solid #333;">
		...
		<div class="font12 center yahei" style="padding-top:20px;height:10px;">
	 	...
	 	<div class="font12 center yahei" style="padding-top:10px;padding-bottom:8px;height:10px;">
	 	...
	 	<div class="font12 center yahei" style="padding-top:15px;_padding-top:5px;">
	   	...
	   	<div class="dotDiv"></div>
	   	<div class="font12 left yahei" style="padding-top:10px;padding-bottom:20px;">
