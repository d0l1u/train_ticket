...
.pass_inp, .pass_sel {width:240px; height:35px; margin:3px 0; display:block; border-radius:3px;padding-left:10px;border:0px solid #e9e9e9; background:none;}
					...
					<div id="InsuranceInfo">
						<table style="width:100%;margin:0 0 0 0;padding:0 0 0 0;" >
							 	...
							 	<tr>
							 		<td>手机号：</td>
							 		<td class="text_item" >
							 				<input type="text" class="pass_ziti pass_inp" autocomplete="off" placeholder="用于接收通知短信" name="link_phone" id="link_phone">
									</td>
							 	</tr>
