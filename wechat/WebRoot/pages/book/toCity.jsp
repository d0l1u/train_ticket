...
<script type="text/javascript"> 
		localStorage.setItem("endCity",document.getElementById('toZh').value); 	 	
	    function mymove(){
		...
		function buttonOk(){
			...
			if($.trim($("#toZh").val())==""){
				...
				var toZh = document.getElementById('toZh').value;
				localStorage.setItem("endCity",toZh); 
				//document.write("toZh: " + localStorage.getItem("endCity"));
			}
...
<div class="screen">
	...
	<div class="wrap">
		<header id="bar">
			<a href="javascript:window.history.back();" class="m19e_ret"><span></span></a>
			<h1>到达城市</h1>
