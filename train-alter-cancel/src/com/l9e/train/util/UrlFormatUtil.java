...
public class UrlFormatUtil {
	...
	public final static String getMd5(String strSrc) throws Exception {
		...
		public static String createUrl(String gateway,Map params) throws Exception{
			...
			parameter.append("&DeviceNo="+params.get("DeviceNo"));
			parameter.append("&FromCity3c="+params.get("FromCity3c"));
			parameter.append("&ToCity3c="+params.get("ToCity3c"));
			parameter.append("&Param1="+URLEncoder.encode(String.valueOf(params.get("Param1")), "GBK"));
