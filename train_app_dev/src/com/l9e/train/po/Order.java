...
public class Order {
    ...
    public CtripAcc ctripAcc; //携程账号实体类
    ...
    public Integer if12306CutOver;//是否切入12306出票   0：否  1：是
    public Integer resendIndetify;//重发类型：   0：无变化重发   1：切换12306账号重发  2：切换京东账号重发  3：切换京东预付卡重发
    public Integer jdbookResendnum;//京东预定重发次数
	...
	public Integer getIf12306CutOver() {
		return if12306CutOver;
	}

	public void setIf12306CutOver(Integer if12306CutOver) {
		this.if12306CutOver = if12306CutOver;
	}

	public Integer getResendIndetify() {
		return resendIndetify;
	}

	public void setResendIndetify(Integer resendIndetify) {
		this.resendIndetify = resendIndetify;
	}

	public Integer getJdbookResendnum() {
		return jdbookResendnum;
	}

	public void setJdbookResendnum(Integer jdbookResendnum) {
		this.jdbookResendnum = jdbookResendnum;
	}
