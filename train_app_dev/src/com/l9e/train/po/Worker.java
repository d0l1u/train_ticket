...
public class Worker implements Serializable {
	 ...
	 * 机器人类型：京东预定机器人
	 */
	public static final Integer TYPE_JD = 44;
	...
	public String toString() {
		return "Worker [stopReason=" + stopReason + ", workNum=" + workNum
				+ ", workTime=" + workTime + ", workerExt=" + workerExt
				+ ", workerId=" + workerId + ", workerName=" + workerName
				+ ", workerStatus=" + workerStatus + ", workerType="
				+ workerType +", workerLangType=" + workerLangType + "]";
	}
