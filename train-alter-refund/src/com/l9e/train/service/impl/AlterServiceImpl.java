...
public class AlterServiceImpl {
	...
	private static Logger logger = LoggerFactory.getLogger(AlterServiceImpl.class);	
...
//				sql.append("SELECT cc,fz,dz,yz,rz,yws,ywz,ywx,rws,rwx,rz2,rz1 FROM t_zjpj_a ");
//				sql.append("WHERE fz like CONCAT(?, '%') AND dz like CONCAT(?, '%')");
