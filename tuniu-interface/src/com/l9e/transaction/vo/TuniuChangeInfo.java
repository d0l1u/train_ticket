...
public class TuniuChangeInfo {
	...
	/**
	 * 是否支持改签到无座票，1、不允许 0、允许
	 */
	private Integer hasSeat;
	
	private String option_time;
	
	private Integer isChooseSeats;  //是否选座, true:选, false:非选
	
	private String chooseSeats;  //选座信息(选座个数要和乘客数量一致)
	
	private String pay_limit_time;//途牛清位时间
	
	
	/**
	 * 改签记录所改签的车票
	 */
	private List<TuniuChangePassengerInfo> cPassengers;
	...
	public List<TuniuChangePassengerInfo> getcPassengers() {
		return cPassengers;
	}

	public void setcPassengers(List<TuniuChangePassengerInfo> cPassengers) {
