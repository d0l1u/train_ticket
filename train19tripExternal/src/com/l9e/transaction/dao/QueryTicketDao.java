...
public interface QueryTicketDao {
	...
	String queryZmByStationCode(String code);

	String queryStartStationBySinfo(String train_code);

	String queryEndStationBySinfo(String train_code);

	Station findStartStationBySinfo(String train_code);

	Station findEndStationBySinfo(String train_code);
}
