...
<div class="order_list mb10">
	<h2>
		...
		<span class="nav_mid_bg"><strong><a href="/query/queryIndex.jhtml">更多 >></a></strong>最新订单</span>
	...
	<ul class="oz">
	    <c:forEach items="${lastestOrderList}" var="order" varStatus="idx">
			<li>
				<ul class="oz">
					<li>
						<a href="/query/queryOrderDetail.jhtml?order_id=${order.order_id}&type=detail">${order.from_city}-${order.to_city}</a>
					</li>
					<li>
