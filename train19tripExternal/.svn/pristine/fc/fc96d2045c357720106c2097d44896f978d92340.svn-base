...
public class QueryTicketServiceImpl implements QueryTicketService {
	...
	public String queryZmByStationCode(String code) {
		...
		return queryDao.queryZmByStationCode(code);
	}

	@Override
	public String queryStartStationBySinfo(String train_code) {
		// TODO Auto-generated method stub
		return queryDao.queryStartStationBySinfo(train_code);
	}

	@Override
	public String queryEndStationBySinfo(String train_code) {
		// TODO Auto-generated method stub
		return queryDao.queryEndStationBySinfo(train_code);
	}

	@Override
	public Station findStartStationBySinfo(String station_train_code) {
		// TODO Auto-generated method stub
		return queryDao.findStartStationBySinfo(station_train_code);
	}

	@Override
	public Station findEndStationBySinfo(String station_train_code) {
		// TODO Auto-generated method stub
		return queryDao.findEndStationBySinfo(station_train_code);
	};
