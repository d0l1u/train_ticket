...
$().ready(function(){
	addressInit('province', 'city', 'district');//省市区三级联动
});
//全局变量
...
function saveAddress(){
	...
	if(linkName == true && addressName == true && zipCode == true && addresseePhone == true){
		...
		var url = "/login/addAddress.jhtml?addressee="+addressee+"&address_name="+address_name+"&addressee_phone="+addressee_phone+"&zip_code="+zip_code+"&province="+province+"&city="+city+"&district="+district+"&version="+new Date();
...
<div class="travel_con">
    ...
    <!--右边内容 start-->  
	<div class="right_con">
	<form id="trainForm" action="/login/addAddress.jhtml" method="post">
		<ul class="MyOrder">
    		<li>新增地址</li>
    	</ul>
        <table class="MyInmatable">
	        <tr>
		        ...
		        <td><input type="text" id="addressee" name="addressee" class="text" onblur="checkName();" /><span id="addressee_info"></span></td>
	        </tr>
	        ...
	        <tr>
		        ...
		        <td><input type="text" id="address_name" name="address_name" class="text changads" value="请填写详细地址，不需要重复填写省市区/县"
	        ...
	        <tr>
		        ...
		        <td><input type="text" id="zip_code" name="zip_code" class="text" onblur="checkZipcode();"/><span id="zip_code_info"></span></td>
	        </tr>
	        
	        <tr>
		        <td class="right"><b>*</b>&nbsp;手机号码：</td>
		        <td><input type="text" id="addressee_phone" name="addressee_phone" class="text" onblur="checkPhone();"/><span id="addressee_phone_info"></span></td>
	        </tr>
