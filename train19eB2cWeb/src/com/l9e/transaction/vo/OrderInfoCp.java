...
public class OrderInfoCp implements Serializable {
	...
	private String ids_type;//证件类型１、一代身份证、２、二代身份证、３、港澳通行证、４、台湾通行证、５、护照
	...
	private String seat_type;//座位类型：0、商务座 1、特等座 2、一等座 3、二等座 4、高级软卧 5、软卧 6、硬卧 7、 软座 8、硬座 9、无座 10、其他
	private String train_box;//车厢
	private String seat_no;//座位号
	private String refund_status;//退款状态：00:无退票 11: 同意退票 22: 拒绝退票 33:退票完成 44:退票失败
