...
public interface OrderDao {
	...
	void updateOrderInfoBx(OrderInfoBx orderInfoBx);

	void updateOrderInfoPs(OrderInfoPs orderInfoPs);

	Map<String, String> queryOrderInfoBxfp(String orderId);

	void addRefundNotify(Map<String, String> refundMap);

	int updateRefundNotifyBegin(Map<String, String> paramMap);

	void updateCpRefundStatus(Map<String, String> refundReMap);
