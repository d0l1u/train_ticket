...
public class CopyOfEmappSignUtil {
	private static final Logger logger = Logger.getLogger(CopyOfEmappSignUtil.class);
	 ...
	 */
	public static boolean checkReqSign(Map<String, String> hm, String hmac, String appInitKey) {
		try {
			if (hm.isEmpty()) {
				return false;
			}
			...
			if (signString != null && signString.equals(hmac)) {
				...
				logger.error("验证的加密串失败|" + sString + "|key=" + appInitKey + "|hmac=" + signString);
			}
...
//			});
	...
	public static void main(String[] args) {
		...
		num[5][0]="status";
		num[5][1]="11";
		System.out.println("最后返回的信息为:"+CopyOfEmappSignUtil.creatResSign(num, appInitKey));
		...
		boolean flag=false;
		flag=CopyOfEmappSignUtil.checkReqSign(map, KeyedDigestMD5.getKeyedDigest(signData.toString(), "nihao"), "nihao");
