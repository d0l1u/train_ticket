...
public class MobileMsgUtil {
	...
	public boolean send(String phoneNo, String content,String channel){
...
//		String channel = commonService.querySysSettingByKey("mobile_msg_channel");
		if(StringUtils.isEmpty(channel)||"00".equals(channel)){
			return sendBy19e(phoneNo, content);
		}else if("11".equals(channel)){
			return sendByDxyd(phoneNo, content);
		}else if("22".equals(channel)){
			return sendByQxt(phoneNo, content);
		}else{
			return sendBy19e(phoneNo, content);
		}
	}
