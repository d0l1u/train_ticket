...
public class TrainConsts {
	...
	/********************出票失败原因NEW code***************************/
	/*
	    900	抱歉，管家代购失败了，购票款将全额退还至您的原支付账户。
		901	票已售完，所购买的车次对应坐席已无票。
		902	行程冲突，对应身份证已实名制购票，不能再次购买同日期同车次的车票。
		904	抱歉，车次信息异常，购票款将全额退还至您的原支付账户。
		905	证件信息错误，请再次核对后重新购买。
		907	未通过12306实名认证，请持本人身份证到火车站或售票窗口完成身份核验。
		908	身份信息待核验，您可以持本人身份证到火车站或售票窗口完成身份核验。
		912	身份信息被冒用，请持本人身份证到火车站或售票窗口完成身份核验。
		
		--- 退票 ---
		该车次无法通过12306在线退票，请前往就近火车站售票窗口办理。
		抱歉，退票失败，请前往就近火车站售票窗口办理。
	 */
	public static final String OUT_FAIL_CODE_900 = "900";//其他
	public static final String OUT_FAIL_CODE_901 = "901";//所购买的车次坐席已无票
	public static final String OUT_FAIL_CODE_902 = "902";//身份证件已经实名制购票，不能再次购买同日期同车次的车票
	public static final String OUT_FAIL_CODE_904 = "904";//车次信息异常
	public static final String OUT_FAIL_CODE_905 = "905";//证件错误
	public static final String OUT_FAIL_CODE_907 = "907";//未通过12306实名认证
	public static final String OUT_FAIL_CODE_908 = "908";//乘客身份信息待核验
	public static final String OUT_FAIL_CODE_912 = "912";//乘客的身份信息涉嫌被他人冒用，请您持本人身份证件，到就近办理客运售票业务的铁路车站完成身份核验。
	...
	static {
		...
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_1,  OUT_FAIL_CODE_901);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_2,  OUT_FAIL_CODE_902);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_4,  OUT_FAIL_CODE_904);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_5,  OUT_FAIL_CODE_905);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_7,  OUT_FAIL_CODE_907);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_8,  OUT_FAIL_CODE_908);
		FAIL_REASON_CODE.put(OUT_FAIL_REASON_12, OUT_FAIL_CODE_912);
		...
		RETURNCODE_TYPE.put(RETURN_CODE_801, "拒绝不存在订单改签和重复申请订单改签。");
		RETURNCODE_TYPE.put(RETURN_CODE_802, "出票成功的订单才可以申请改签。");
	}
