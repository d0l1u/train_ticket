...
<body>
	...
	<form action="/depart/updateDepartAdminUser.do?user_id=${userMap.user_id }&department=${department }" method="post" name="updateForm" id="updateForm" onsubmit="return checkSubmit();">
        <ul class="order_num oz">
        	...
        	<li><span style="color:red">*</span>所在部门：&nbsp;<span style="color:#f60;font-weight:bold;font-family:arial;">
