...
<body>
	...
	<form action="/depart/addDepartAdminPage.do?department=${department }" method="post" name="updateForm" id="updateForm" onsubmit="return checkSubmit();">
        <ul class="order_num oz">
        	<br/><br/><br/>
        	<li><input type="hidden" name="user_id" value="${userInfo_Map.user_id }"/></li>
        	<li><span style="color:red">*</span>登陆账号：&nbsp;<input type="text" name="user_name" id="user_name" onblur="onblurUsername()" onfocus="focusUsername()"style="width: 140px;"/><span id="username_info"style="width: 140px;"></span></li>
        	<li><span style="color:red">*</span>真实姓名：&nbsp;<input type="text" name="real_name" id="real_name" onblur="onblurRealname()" onfocus="focusRealname()"style="width: 140px;"/><span id="realname_info"></span></li>
