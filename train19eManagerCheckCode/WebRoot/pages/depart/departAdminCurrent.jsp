...
<html>
	...
	<body>
		...
		<div class="book_manage oz">
			<form action="/depart/queryDepartCurrentPage.do" method="post" name="myform" id="myform">
			...
			<p>
				所在部门：<span style="color:#f60;font-weight:bold;font-family:arial;font-size:16px;">	
					...
					当前打码总共：<span style="color:#f60;font-weight:bold;font-family:arial;font-size:16px;">${totalCount }</span>人</span>
					<!-- 
					<span style="font-size:14px;float:right;">当前打码总共：<span style="color:#f60;font-weight:bold;font-family:arial;font-size:16px;">${totalCount }</span>人</span>
					 -->
			</p>
				<br />
