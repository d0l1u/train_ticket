...
<html>
	<head>
	    ...
	    <script type="text/javascript">
		    ...
		    function exportExcel() {
				$("form:first").attr("action","/excel/excelAdminExport.do?department="+${department});
				$("form:first").submit();
		    ...
		    function queryUserHour(){
				...
				showlayer('人数分时统计',url,'1000px','500px');
			}
		  	//打码分时统计
		    function queryCodeHour(){
				...
				showlayer('打码分时统计',url,'1000px','500px');
			}	
	    </script>
	</head>
	<body>
	<div style="width:expression(document.body.clientWidth + 'px')">
		<div class="book_manage oz">
			<form action="/depart/queryDepartPicturePageList.do?department=${department}" method="post" name="myform" id="myform">
				...
				<ul class="order_num oz">
					...
					<li>开始时间：&nbsp;&nbsp;&nbsp;
						<input type="text" class="text" name="begin_time" readonly="readonly" value="${begin_time }" id="begin_time"
										onfocus="WdatePicker({doubleCalendar: true ,dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})"/>
					</li>
					<li>结束时间：&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" class="text" name="end_time" readonly="readonly" value="${end_time }" id="end_time"
										onfocus="WdatePicker({doubleCalendar: true ,dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})" />
					</li>
					<!-- 
					<li>
				...
				<p>
					...
					<c:if test="${user_level eq '2' && user_department eq '2' }">
					...
					<table>
						...
						<!-- 	<td>
							...
							<td>
								...
								<c:if test="${list.department eq null }">无</c:if>
