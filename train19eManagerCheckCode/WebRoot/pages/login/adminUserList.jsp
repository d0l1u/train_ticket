...
<html>
	...
	<body>
		...
		<div class="book_manage oz">
			<form action="/loginManager/queryAdminUserList.do" method="post" name="myform" id="myform">
				...
				<c:if test="${!empty isShowList}">
					<table>
						...
						<tr class="nlist_1s">
							...
							<td>
								<a href="javascript:if(confirm('确实要修改用户信息吗?'))location='/loginManager/queryAdminUserInfo.do?opt_ren=${list.username }'">修改</a>
								<a href="javascript:if(confirm('确实要删除该用户吗?'))location='/loginManager/deleteAdmin.do?opt_ren=${list.username }'">删除</a>
							</td>
							</tr>
						</c:forEach>
					</table>
