 ...
 * 针对elong 的MD5加密方式
 * 
 * @author liuyi02 加密规则32位utf-8为大写输出
 * */
@Deprecated
public class TcMd5Util {
	public static String getParam(Map<String, String> params, String sign_key) {
		...
		String returnStr = paramStr.substring(0, paramStr.lastIndexOf("&"))
				+ sign_key;
		return returnStr;
	}
	...
	public static String md5_16(String paramStr, String charSet) {
		return md5_32(paramStr, charSet).substring(8, 16);
	}

	public static String md5_32(Map<String, String> params, String sign_key,
			String charSet) {
		return md5_32(getParam(params, sign_key), charSet);
	}

	public static String md5_16(Map<String, String> params, String sign_key,
			String charSet) {
		return md5_32(params, sign_key, charSet).substring(8, 16);
	}
