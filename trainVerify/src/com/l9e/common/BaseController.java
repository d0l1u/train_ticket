...
public class BaseController {
	...
	//获取支付宝校验码队列
	public static String getAlipayQueue(String cardno) {
		return "com.train.alipay.cardno." + cardno;
	}
	
	//获取建行校验码队列
	public static String getBankQueue(String cardno) {
		return "com.train.bank.cardno." + cardno;
	}
