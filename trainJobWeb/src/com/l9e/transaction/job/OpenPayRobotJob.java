 ...
 */
@Component("openPayRobotJob")
public class OpenPayRobotJob {
	private static final Logger logger = Logger.getLogger(OpenPayRobotJob.class);
	...
	public void openRobot() {
		...
		List<Map<String, String>> list = workerService.queryPayCloseRobots();
